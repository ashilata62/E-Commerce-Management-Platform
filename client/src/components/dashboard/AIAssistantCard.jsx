...
export const AIAssistantCard = ({ insights = [] }) => {
  ...
  return (
    <div className="relative overflow-hidden rounded-3xl ai-card-gradient text-white p-6 sm:p-7 shadow-soft-lg">
      ...
      <div className="relative z-10">
        ...
        <div className="flex items-center justify-between gap-3 mb-5">
          <div className="flex items-center gap-2.5">
            <div className="w-9 h-9 rounded-xl bg-white/20 backdrop-blur-md flex items-center justify-center text-white shadow-soft-sm">
            ...
            <div>
              ...
              <p className="text-xs text-white/80 font-medium">Automated predictive growth & inventory intelligence</p>
            </div>
          </div>
        ...
        <div className="space-y-3 mb-5">
          {defaultInsights.map((item, idx) => {
            ...
            return (
              <div
                key={idx}
                className="p-3.5 rounded-2xl bg-white/10 hover:bg-white/15 backdrop-blur-md border border-white/15 transition-all flex items-start gap-3.5"
              >
                ...
                <div className="flex-1 min-w-0">
                  <div className="flex items-center justify-between gap-2">
                    ...
                    <span className="text-[10px] font-extrabold px-1.5 py-0.5 rounded bg-white/20 text-white shrink-0">
                      {item.badge}
                    </span>
                  </div>
                  <p className="text-[11px] text-white/80 mt-0.5 font-medium leading-relaxed">
                    {item.detail}
                  </p>
                </div>
              </div>
        ...
        <button
          ...
          className="w-full flex items-center justify-center gap-2 py-3 px-4 rounded-xl bg-white text-brand-700 hover:bg-brand-50 font-extrabold text-xs sm:text-sm shadow-soft-md transition-all active:scale-95 group"
        >
