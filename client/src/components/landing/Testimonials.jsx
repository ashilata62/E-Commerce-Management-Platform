...
export const Testimonials = () => {
  ...
  return (
    <section className="py-24 bg-brand-600 text-white relative overflow-hidden">
      ...
      <div className="absolute top-0 right-0 w-[500px] h-[500px] bg-brand-500 rounded-full blur-[100px] -z-0 opacity-50" />
      <div className="absolute bottom-0 left-0 w-[400px] h-[400px] bg-coral-500 rounded-full blur-[120px] -z-0 opacity-40" />
      <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[600px] h-[600px] bg-purple-700 rounded-full blur-[150px] -z-0 opacity-20" />
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="text-center mb-16 max-w-3xl mx-auto">
          <motion.div
            ...
            viewport={{ once: true }}
            className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-white/10 backdrop-blur-md text-brand-100 text-sm font-semibold mb-4 border border-white/20"
          >
          ...
          <motion.p 
            ...
            className="text-xl text-brand-100 font-medium leading-relaxed"
          >
            ...
            <AnimatePresence mode="popLayout">
              {visibleTestimonials.map((test, i) => (
                <motion.div 
                  ...
                  className="bg-white/10 backdrop-blur-md border border-white/20 p-8 rounded-3xl cursor-pointer hover:bg-white/15 transition-all shadow-xl flex flex-col justify-between"
                >
                  <div>
                    ...
                    <p className="text-lg text-white/95 font-medium leading-relaxed mb-8">
                      "{test.text}"
                    </p>
                  </div>
                  ...
                  <div className="flex items-center gap-4 pt-4 border-t border-white/10">
                    ...
                    />
                    <div>
                      <div className="font-bold text-white text-base">{test.name}</div>
                      <div className="text-sm text-brand-200">{test.role}</div>
                    </div>
                  </div>
                </motion.div>
              ))}
