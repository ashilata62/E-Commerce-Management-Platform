...
export const HowItWorks = () => {
  ...
  return (
    <section id="how-it-works" className="py-24 bg-white border-b border-surface-border">
              ...
              {steps.map((step, i) => (
                 ...
                 >
                    <div className="relative mb-8">
                       <div className={`w-24 h-24 rounded-full flex items-center justify-center border-8 border-white shadow-soft-lg ${getColorClasses(step.color)} bg-white z-10 relative group-hover:scale-110 transition-transform duration-500`}>
                          {step.icon}
                       </div>
                       <div className="absolute -top-4 -right-4 font-black text-4xl text-surface-muted/50 group-hover:text-surface-muted transition-colors">
                          {step.num}
                       </div>
                    </div>
                    
                    <h3 className="text-xl font-bold text-slateText-main mb-3 group-hover:text-brand-600 transition-colors">
                      {step.title}
                    </h3>
